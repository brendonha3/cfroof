<!--- 
    ...
    v3 -- implementation of cfscript, removal of most logic from frontend and converting to cfscript

--->

<cfinclude template="_header.cfm">

<cfinclude template="admin_people_detail_code.cfm">
        ...
        <div class="gradient-overlay" style="">
            <div class="media text-center">
                <div class="media">
                    ...
                    <cfelse>
                        <i class="#profileIcon#" style="font-size:50px;"></i> 
                    </cfif>
                </div>
